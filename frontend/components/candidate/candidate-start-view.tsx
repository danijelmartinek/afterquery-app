            ...
            >
              ...
              <dl className="mt-4 grid gap-4 text-xs text-zinc-600 sm:grid-cols-3">
                <div>
                  ...
                  <dd className="mt-1 text-sm text-zinc-900">{startBy ?? "No start deadline"}</dd>
                </div>
                <div>
                  <dt className="font-medium text-zinc-700">Started</dt>
                  <dd className="mt-1 text-sm text-zinc-900">{startedAt ?? "Not yet started"}</dd>
                </div>
                <div>
                  <dt className="font-medium text-zinc-700">Complete by</dt>
                  <dd className="mt-1 text-sm text-zinc-900">{completionWindowLabel}</dd>
                </div>
              </dl>
            </div>
            <div>
